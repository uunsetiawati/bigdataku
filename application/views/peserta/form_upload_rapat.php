    ...
    <div class="container">
        <div class="social-media-icon socmed-for-about shadow-sm">
            <div class="coming-soon-word text-center">
                <h4>UPLOAD DATA PESERTA RAPAT</h4>
            </div>                          
        </div>
    </div>
</div>
...
<div class="container">
    <div class="button-default">
        <!-- <a href="uploads/file/uploadexcel.xlsx" class="button4">Download Template Excel</a> -->
            <?php
        echo anchor('uploads/file/RAPAT.xlsx', 'Download Template Excel', array('class'=>'button4'));
        ?>
    </div>

    <hr>

    <form action="<?= site_url('UploadController/uploadExcelRapat/') ?>" method="post" enctype="multipart/form-data" id="add" class="form-outline">
    <?php 
...
<div class="separator-large"></div>
    ...
    var table = $('#list').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "<?php echo site_url('UploadController/data_rapat'); ?>",
            "type": "POST",
            "data": function(d) {
