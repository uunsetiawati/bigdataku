    ...
    <div class="container">
        <div class="social-media-icon socmed-for-about shadow-sm">
            <div class="coming-soon-word text-center">
                <h4>UPLOAD DATA PESERTA KOPERASI</h4>
...
<div class="container">
    ...
    <form action="<?= site_url('UploadController/uploadExcelKoperasi/') ?>" method="post" enctype="multipart/form-data" id="add" class="form-outline">
    <?php 
...
<div class="separator-large"></div>
    ...
    var table = $('#list').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "<?php echo site_url('UploadController/data_koperasi'); ?>",
            "type": "POST",
            "data": function(d) {
