            ...
            <div class="content">
				<div class="container">
					<div class="row">
                        <div class="col-3">
                            <?php
                                echo anchor('klasifikasi/add', '<button class="button button-fill button-small">Tambah Data</button>');
                            ?>
                        </div>                                                                                      
                    </div>
                    <div class="card">
	...
	<script>
        ...
        $(document).ready(function () {
            $('#list').DataTable({
                ...
                // of the DataTable
                "searching": true,
                "ajax": '<?php echo site_url('klasifikasi/data'); ?>',
                "order": [[ 0, 'asc' ]],
                "columns": [                    
                    {    
                        "data": null,
